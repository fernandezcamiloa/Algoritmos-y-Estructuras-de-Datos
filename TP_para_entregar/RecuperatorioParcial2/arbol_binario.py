...
#Parcial 2, ejercicio 1
    ...
    def inorden_number(self, numero):
    ...
    def contar_tipo(self, value):
        def __contar_tipo(root, value):
            count = 0
            if root is not None:
                if root.value == value:
                    count = 1
                count += __contar_tipo(root.left, value)
                count += __contar_tipo(root.right, value)
            return count

        return __contar_tipo(self.root, value)
